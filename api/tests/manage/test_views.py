...
def test_user_view(factories, superuser_api_client, mocker):
    ...
    url = reverse("api:v2:manage:users:users-list")
...
def test_invitation_view(factories, superuser_api_client, mocker):
    ...
    url = reverse("api:v2:manage:users:invitations-list")
...
def test_domain_list(factories, superuser_api_client, settings):
    ...
    url = reverse("api:v2:manage:federation:domains-list")
...
def test_domain_detail(factories, superuser_api_client):
    d = factories["federation.Domain"]()
    url = reverse("api:v2:manage:federation:domains-detail", kwargs={"pk": d.name})
    response = superuser_api_client.get(url)
...
def test_domain_update_allowed(superuser_api_client, factories):
    ...
    url = reverse("api:v2:manage:federation:domains-detail", kwargs={"pk": domain.name})
...
def test_domain_update_cannot_change_name(superuser_api_client, factories):
    ...
    url = reverse("api:v2:manage:federation:domains-detail", kwargs={"pk": old_name})
...
def test_domain_nodeinfo(factories, superuser_api_client, mocker):
    domain = factories["federation.Domain"]()
    url = reverse(
        "api:v2:manage:federation:domains-nodeinfo", kwargs={"pk": domain.name}
    )
    mocker.patch.object(
...
def test_domain_stats(factories, superuser_api_client, mocker):
    ...
    url = reverse("api:v2:manage:federation:domains-stats", kwargs={"pk": domain.name})
    response = superuser_api_client.get(url)
    assert response.status_code == 200
...
def test_actor_list(factories, superuser_api_client, settings):
    ...
    url = reverse("api:v2:manage:accounts-list")
    response = superuser_api_client.get(url)
...
def test_actor_detail(factories, superuser_api_client):
    actor = factories["federation.Actor"]()
    url = reverse("api:v2:manage:accounts-detail", kwargs={"pk": actor.full_username})
    response = superuser_api_client.get(url)
...
def test_instance_policy_create(superuser_api_client, factories):
    ...
    url = reverse("api:v2:manage:moderation:instance-policies-list")
...
def test_artist_list(factories, superuser_api_client, settings):
    ...
    url = reverse("api:v2:manage:library:artists-list")
    response = superuser_api_client.get(url)
...
def test_artist_detail(factories, superuser_api_client):
    artist = factories["music.Artist"]()
    url = reverse("api:v2:manage:library:artists-detail", kwargs={"pk": artist.pk})
    response = superuser_api_client.get(url)
...
def test_artist_detail_stats(factories, superuser_api_client):
    artist = factories["music.Artist"]()
    url = reverse("api:v2:manage:library:artists-stats", kwargs={"pk": artist.pk})
    response = superuser_api_client.get(url)
    expected = {
        "libraries": 0,
        "channels": 0,
...
def test_album_list(factories, superuser_api_client, settings):
    ...
    url = reverse("api:v2:manage:library:albums-list")
...
def test_album_detail(factories, superuser_api_client):
    album = factories["music.Album"]()
    url = reverse("api:v2:manage:library:albums-detail", kwargs={"pk": album.pk})
    response = superuser_api_client.get(url)
...
def test_album_detail_stats(factories, superuser_api_client):
    album = factories["music.Album"]()
    url = reverse("api:v2:manage:library:albums-stats", kwargs={"pk": album.pk})
    response = superuser_api_client.get(url)
    expected = {
        "libraries": 0,
        "channels": 0,
...
def test_track_list(factories, superuser_api_client, settings):
    ...
    url = reverse("api:v2:manage:library:tracks-list")
    response = superuser_api_client.get(url)
...
def test_track_detail(factories, superuser_api_client):
    track = factories["music.Track"]()
    url = reverse("api:v2:manage:library:tracks-detail", kwargs={"pk": track.pk})
    response = superuser_api_client.get(url)
...
def test_track_detail_stats(factories, superuser_api_client):
    track = factories["music.Track"]()
    url = reverse("api:v2:manage:library:tracks-stats", kwargs={"pk": track.pk})
    response = superuser_api_client.get(url)
    expected = {
        "libraries": 0,
        "channels": 0,
...
def test_library_list(factories, superuser_api_client, settings):
    ...
    url = reverse("api:v2:manage:library:libraries-list")
    response = superuser_api_client.get(url)
...
def test_library_detail(factories, superuser_api_client):
    library = factories["music.Library"]()
    url = reverse(
        "api:v2:manage:library:libraries-detail", kwargs={"uuid": library.uuid}
    )
    response = superuser_api_client.get(url)
...
def test_library_detail_stats(factories, superuser_api_client):
    library = factories["music.Library"]()
    url = reverse(
        "api:v2:manage:library:libraries-stats", kwargs={"uuid": library.uuid}
    )
    response = superuser_api_client.get(url)
    expected = {
        "uploads": 0,
...
def test_upload_list(factories, superuser_api_client, settings):
    ...
    url = reverse("api:v2:manage:library:uploads-list")
    response = superuser_api_client.get(url)
...
def test_upload_detail(factories, superuser_api_client):
    upload = factories["music.Upload"]()
    url = reverse("api:v2:manage:library:uploads-detail", kwargs={"uuid": upload.uuid})
    response = superuser_api_client.get(url)
...
def test_note_create_actor(factories, superuser_api_client):
    ...
    url = reverse("api:v2:manage:moderation:notes-list")
...
def test_note_delete(factories, superuser_api_client):
    note = factories["moderation.Note"]()
    url = reverse("api:v2:manage:moderation:notes-detail", kwargs={"uuid": note.uuid})
    response = superuser_api_client.delete(url)
...
def test_tag_detail(factories, superuser_api_client):
    ...
    url = reverse("api:v2:manage:tags-detail", kwargs={"name": tag.name})
    response = superuser_api_client.get(url)
...
def test_tag_list(factories, superuser_api_client, settings):
    tag = factories["tags.Tag"]()
    url = reverse("api:v2:manage:tags-list")
    response = superuser_api_client.get(url)
...
def test_report_detail(factories, superuser_api_client):
    ...
    url = reverse(
        "api:v2:manage:moderation:reports-detail", kwargs={"uuid": report.uuid}
    )
    response = superuser_api_client.get(url)
...
def test_report_list(factories, superuser_api_client, settings):
    report = factories["moderation.Report"]()
    url = reverse("api:v2:manage:moderation:reports-list")
    response = superuser_api_client.get(url)
...
def test_request_detail(factories, superuser_api_client):
    ...
    url = reverse(
        "api:v2:manage:moderation:requests-detail", kwargs={"uuid": request.uuid}
    )
    response = superuser_api_client.get(url)
...
def test_request_list(factories, superuser_api_client, settings):
    request = factories["moderation.UserRequest"]()
    url = reverse("api:v2:manage:moderation:requests-list")
    response = superuser_api_client.get(url)
...
def test_user_request_update(factories, superuser_api_client):
    ...
    url = reverse(
        "api:v2:manage:moderation:requests-detail", kwargs={"uuid": user_request.uuid}
    )
...
def test_channel_list(factories, superuser_api_client, settings):
    ...
    url = reverse("api:v2:manage:channels-list")
    response = superuser_api_client.get(url)
...
def test_channel_detail(factories, superuser_api_client):
    channel = factories["audio.Channel"]()
    url = reverse("api:v2:manage:channels-detail", kwargs={"composite": channel.uuid})
    response = superuser_api_client.get(url)
...
def test_channel_detail_stats(factories, superuser_api_client):
    channel = factories["audio.Channel"]()
    url = reverse("api:v2:manage:channels-stats", kwargs={"composite": channel.uuid})
    response = superuser_api_client.get(url)
    expected = {
        "uploads": 0,
        "playlists": 0,
