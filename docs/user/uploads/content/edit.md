...
```{note}
You can only edit content you own. {term}`Pod` admins can edit all content.
```

You can edit content after you have uploaded it. This is helpful if the content isn't [tagged](tag.md).
...
1. Search for the artist in the sidebar.
...
1. Search for the album in the sidebar.
